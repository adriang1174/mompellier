...
<div id="container">
    ...
    <?php if (isset($_GET["aa"])) { ?>
            ...
            <div class="header" style="background-image:url(<?php root() ?><?php ponerHeaderImg() ?>)">
                ...
                <?php if (isset($_GET["inscripcion"])) { ?>
					<a href="<?php root() ?>/?aa=<?php $_GET["aa"] ?>&evento=<?php $_GET["evento"] ?>&inscripcion=form" class="botonInscribite"></a>
     ...
     <?php } else { ?>
        ...
        <div class="header" style="background-image:url(<?php root() ?><?php ponerHeaderImg() ?>)">
            ...
            <a href="<?php root() ?>?inscripcion=1" class="botonInscribite"></a>
			<div class="botonComparti">
            	<span>Compartí</span>
            	<!-- AddThis Button BEGIN -->
                <div class="addthis_toolbox addthis_default_style addthis_32x32_style">
    ...
    <div class="columnaIzq">
    	...
    	<?php if ((isset($_GET["inscripcion"])) && ($_GET["inscripcion"]=="form")) { ?>
    ...
    <div class="columnaDer">
        ...
        <a href="/2013/SegundasJornadasAcademicas" target="_blank" class="botonEventoProximo"></a> 
